...
public class TechniqueStatesFunctions
    ...
    /**
     * Floating-point values passed to `blendColor()`. [red, green, blue, alpha] (optional)<br>
     ...
     * Array elements:<br>
     * &nbsp;&nbsp;The elements of this array (optional)<br>
     * &nbsp;&nbsp;Valid values: [0, 1, 768, 769, 774, 775, 770, 771, 772, 773, 32769, 32770, 32771, 32772, 776]
     * 
     */
    private int[] blendFuncSeparate;

    /**
     * Boolean values passed to `colorMask()`. [red, green, blue, alpha]. (optional)<br>
    ...
    /**
     * Floating-point values passed to `depthRange()`. [zNear, zFar] (optional)<br>
     * Default: [0.0,1.0]<br>
     * Number of items: 2<br>
     * Array elements:<br>
     * &nbsp;&nbsp;The elements of this array (optional)
    ...
    /**
     * Floating-point value passed to `polygonOffset()`. [factor, units] (optional)<br>
     * Default: [0.0,0.0]<br>
     * Number of items: 2<br>
     * Array elements:<br>
     * &nbsp;&nbsp;The elements of this array (optional)
    ...
    /**
     * Floating-point value passed to `scissor()`. [x, y, width, height]. (optional)<br>
     * Default: [0.0,0.0,0.0,0.0]<br>
     * Number of items: 4<br>
     * Array elements:<br>
     * &nbsp;&nbsp;The elements of this array (optional)
    ...
    public void setBlendEquationSeparate(int[] blendEquationSeparate) {
        ...
        for (int blendEquationSeparateElement : blendEquationSeparate) {
            if (((blendEquationSeparateElement != 32774) && (blendEquationSeparateElement != 32778))
                ...
                throw new IllegalArgumentException((("Invalid value for blendEquationSeparateElement: " + blendEquationSeparateElement)
    ...
    public void setBlendFuncSeparate(int[] blendFuncSeparate) {
        ...
        for (int blendFuncSeparateElement : blendFuncSeparate) {
            if (((((((((((((((blendFuncSeparateElement != 0) && (blendFuncSeparateElement != 1)) && (blendFuncSeparateElement != 768))
                && (blendFuncSeparateElement != 769)) && (blendFuncSeparateElement != 774)) && (blendFuncSeparateElement != 775))
                && (blendFuncSeparateElement != 770)) && (blendFuncSeparateElement != 771)) && (blendFuncSeparateElement != 772))
                && (blendFuncSeparateElement != 773)) && (blendFuncSeparateElement != 32769)) && (blendFuncSeparateElement != 32770))
                && (blendFuncSeparateElement != 32771)) && (blendFuncSeparateElement != 32772)) && (blendFuncSeparateElement != 776)) {
                throw new IllegalArgumentException((("Invalid value for blendFuncSeparateElement: " + blendFuncSeparateElement)
                    + ", valid: [0, 1, 768, 769, 774, 775, 770, 771, 772, 773, 32769, 32770, 32771, 32772, 776]"));
            }
        }
        this.blendFuncSeparate = blendFuncSeparate;
    }
    ...
    public void setDepthFunc(int[] depthFunc) {
        ...
        for (int depthFuncElement : depthFunc) {
            if ((((((((depthFuncElement != 512) && (depthFuncElement != 513)) && (depthFuncElement != 515)) && (depthFuncElement != 514))
                && (depthFuncElement != 516)) && (depthFuncElement != 517)) && (depthFuncElement != 518)) && (depthFuncElement != 519)) {
                throw new IllegalArgumentException(
                    (("Invalid value for depthFuncElement: " + depthFuncElement) + ", valid: [512, 513, 515, 514, 516, 517, 518, 519]"));
            }
        }
        this.depthFunc = depthFunc;
    }
