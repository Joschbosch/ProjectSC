...
/**
 * A typed view into a bufferView. A bufferView contains raw binary data. An accessor provides a typed view into a bufferView or a subset of
 * a bufferView similar to how WebGL's `vertexAttribPointer()` defines an attribute in a buffer.
 * 
...
public class Accessor
    ...
    /**
     * The offset relative to the start of the bufferView in bytes. (required)<br>
     * Minimum: 0 (inclusive)
     * 
     */
    ...
    /**
     * The stride, in bytes, between attributes referenced by this accessor. (optional)<br>
     * Default: 0<br>
    ...
    /**
     * Specifies if the attribute is a scalar, vector, or matrix. (required)<br>
    ...
    public void setComponentType(Integer componentType) {
        ...
        if (((((componentType != 5120) && (componentType != 5121)) && (componentType != 5122)) && (componentType != 5123))
            ...
            throw new IllegalArgumentException(
                (("Invalid value for componentType: " + componentType) + ", valid: [5120, 5121, 5122, 5123, 5126]"));
        }
    ...
    public void setType(String type) {
        ...
        if (((((((!"SCALAR".equals(type)) && (!"VEC2".equals(type))) && (!"VEC3".equals(type))) && (!"VEC4".equals(type)))
