...
public class AnimationSampler
    ...
    /**
     * The ID of a parameter in this animation to use as keyframe input, e.g., time. (required)
     * 
     */
    ...
    /**
     * The ID of a parameter in this animation to use as keyframe output. (required)
     * 
     */
