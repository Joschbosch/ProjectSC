...
public class TechniqueStates
    ...
    /**
     * Arguments for fixed-function rendering state functions other than `enable()`/`disable()`. (optional)
     * 
     */
    ...
    public void setEnable(List<Integer> enable) {
        ...
        for (Integer enableElement : enable) {
            if ((((((enableElement != 3042) && (enableElement != 2884)) && (enableElement != 2929)) && (enableElement != 32823))
                && (enableElement != 32926)) && (enableElement != 3089)) {
                throw new IllegalArgumentException(
                    (("Invalid value for enableElement: " + enableElement) + ", valid: [3042, 2884, 2929, 32823, 32926, 3089]"));
            }
        }
        this.enable = enable;
    }
