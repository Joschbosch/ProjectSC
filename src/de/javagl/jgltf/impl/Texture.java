...
public class Texture
    ...
    public void setInternalFormat(Integer internalFormat) {
        ...
        if (((((internalFormat != 6406) && (internalFormat != 6407)) && (internalFormat != 6408)) && (internalFormat != 6409))
            && (internalFormat != 6410)) {
            throw new IllegalArgumentException(
                (("Invalid value for internalFormat: " + internalFormat) + ", valid: [6406, 6407, 6408, 6409, 6410]"));
        }
        this.internalFormat = internalFormat;
    }
