...
//import de.projectsc.core.modes.client.gui.components.graphical.ModelAndTextureComponent;
//import de.projectsc.core.modes.client.gui.components.graphical.ParticleEmitterComponent;
...
//                            newEntitySchema.setScales((float) tree.get("scale").getDoubleValue());
...
//        }
//        if (VelocityComponent.NAME.equals(component)) {
//            newComponent = new VelocityComponent(newEntitySchema);
//        }
...
//            entitySchemaAtCursor.setScales(entitySchemaAtCursor.getScales() + 0.5f);
...
//                component.setScales(component.getScales() + 0.5f);
//            }
//        }
//        if (Keyboard.isKeyDown(Keyboard.KEY_F)) {
//            if (entitySchemaAtCursor.getScales() > 0.5) {
//                entitySchemaAtCursor.setScales(entitySchemaAtCursor.getScales() - 0.5f);
//                if (entitySchemaAtCursor.hasComponent(BoundingComponent.class)) {
//                    BoundingComponent component = entitySchemaAtCursor.getComponent(BoundingComponent.class);
//                    component.setScales(component.getScales() - 0.5f);
