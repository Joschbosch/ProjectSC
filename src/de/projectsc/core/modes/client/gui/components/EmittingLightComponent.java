...
public class EmittingLightComponent extends GraphicalComponent {
    ...
    public void update(long owner) {
        for (Light l : lights) {
            l.setPosition(Vector3f.add(getEntityPosition(), offsets.get(l), null));
        }
    }
     ...
     * @param light to add
     */
    public void addLight(long entity, Light light) {
        offsets.put(light, light.getPosition());
        light.setPosition(Vector3f.add(getEntityPosition(), light.getPosition(), null));
        lights.add(light);
    }
     ...
     * @param name of the light
     */
    public void createAndAddLight(long entity, Vector3f color, String name) {
        createAndAddLight(entity, new Vector3f(0, 0, 0), color, new Vector3f(1.0f, 0, 0), name);
    }
     ...
     * @param name of the light
     */
    public void createAndAddLight(long entity, Vector3f offset, Vector3f color, String name) {
        createAndAddLight(entity, offset, color, new Vector3f(1.0f, 0, 0), name);
    }
     ...
     * @param name of the light
     */
    public void createAndAddLight(long entity, Vector3f offset, Vector3f color, Vector3f attenuation, String name) {
        Light l = new Light(Vector3f.add(getEntityPosition(), offset, null), color, attenuation, name);
        lights.add(l);
