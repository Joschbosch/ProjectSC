...
public class GUIText {
    ...
    private final Vector3f outlineColor = new Vector3f(0.0f, 0.0f, 0.0f);
     ...
     * @param position - the position on the screen where the top left corner of the text should be rendered. The top left corner of the
     *        screen is (0, 0) and the bottom right is (1, 1).
     * @param maxLineLength - basically the width of the virtual page in terms of screen width (1 is full screen width, 0.5 is half the
     *        width of the screen, etc.) Text cannot go off the edge of the page, so if the text is longer than this length it will go onto
     *        the next line. When text is centered it is centered into the middle of the line, based on this line length value.
    ...
    /**
     * @return The number of lines of text. This is determined when the text is loaded, based on the length of the text and the max line
     *         length that is set.
     */
    ...
    /**
     * @return The position of the top-left corner of the text in screen-space. (0, 0) is the top left corner of the screen, (1, 1) is the
     *         bottom right.
     */
