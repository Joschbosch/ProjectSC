...
/**
 * The frame buffer for the shadow pass. This class sets up the depth texture which can be rendered to during the shadow render pass,
 * producing a shadow map.
 * 
 * @author Karl TM
 *
 */
public class ShadowFrameBuffer {
    ...
    /**
     * Creates a frame buffer and binds it so that attachments can be added to it. The draw buffer is set to none, indicating that there's
     * no colour buffer to be rendered to.
     * 
