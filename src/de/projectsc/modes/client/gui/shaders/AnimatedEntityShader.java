...
public class AnimatedEntityShader extends Shader {
    ...
    private static final Log LOGGER = LogFactory.getLog(AnimatedEntityShader.class);

    private static final String VERTEX_FILE = "animatedEntityShader.vert";

    private static final String FRAGMENT_FILE = "animatedEntityShader.frag";
