...
// previewPanel.setBorder(new TitledBorder(null, "Preview", TitledBorder.LEADING, TitledBorder.TOP,
/// null, null));
...
//
// graphicsCore.removeSelectedEntity();
// }
// });
...
// File folder;
// try {
// folder = new File(MapEditor.class.getResource(SLASHED_MODEL_DIR).toURI());
// File targetFolder = new File(folder, CoreConstants.SCHEME_DIRECTORY_PREFIX + 0);
// targetFolder.mkdirs();
// if (data.getModelFile() != null && !data.getModelFile().equals(new File(targetFolder,
/// MODEL_OBJ))) {
// FileUtils.copyFile(data.getModelFile(), new File(targetFolder, MODEL_OBJ));
// }
// if (data.getTextureFile() != null && !data.getTextureFile().equals(new File(targetFolder,
/// TEXTURE_PNG))) {
// FileUtils.copyFile(data.getTextureFile(), new File(targetFolder, TEXTURE_PNG));
// }
// File nameFile = new File(targetFolder,
/// FilenameUtils.removeExtension(data.getModelFile().getName()));
...
// * The main thread will wait for the Display.destroy()
// * to complete
// */
