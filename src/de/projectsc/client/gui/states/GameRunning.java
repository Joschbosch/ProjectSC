...
import de.projectsc.client.gui.content.MiniMap;
...
public class GameRunning implements State {
    ...
    public void render(long elapsedTime) {
        ...
        masterRenderer.renderScene(terrain, worldEntities, player, lights, camera, elapsedTime, new Vector4f(0, 0 - 1, 0, waters.get(0)
            .getHeight()));
